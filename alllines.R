...
alllines <- function(choice){
      ...
      ##########################################################################################
      Stock = read.table(paste("C:/Users/201604100120131/Desktop/Stock-Prediction-master/stocks/",choice,".csv",sep = ""),sep = ",",header = TRUE)
      
      #/home/local/SRIMCA/201604100120131/Desktop/Stock-Prediction-master/stocks
